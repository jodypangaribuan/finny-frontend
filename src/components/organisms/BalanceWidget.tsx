    ...
    return (
        <Card className="p-6 relative bg-white flex flex-col justify-between h-full">
            ...
            <div className="flex items-end gap-3 mb-1">
                <h2 className="text-[38px] font-bold tracking-tight text-foreground leading-tight">$24,847.84</h2>
                <Badge variant="success" className="mb-2 py-0.5 px-2.5 text-[11px] font-bold">↑ 16.8%</Badge>
            </div>

            <div className="flex items-center gap-2 mb-6 mt-1">
                <span className="text-sm font-mono tracking-wider text-muted-foreground">7484 7475 8383 9384</span>
                <button className="flex items-center gap-1 text-[11px] text-muted-foreground font-medium bg-muted-bg border border-border/60 hover:bg-border/50 px-2.5 py-1 rounded-md transition-colors ml-1">
            ...
            <div className="flex items-center gap-3 w-full mt-auto">
                ...
                <Button variant="outline" className="flex-1 rounded-xl h-12 text-sm font-semibold border-border bg-white text-foreground hover:bg-muted-bg">
                    <IconWrapper icon={ArrowDownLeft} size={18} /> Received
                </Button>
                <Button variant="outline" size="icon" className="shrink-0 h-12 w-12 rounded-xl border-border bg-white text-foreground hover:bg-muted-bg">
